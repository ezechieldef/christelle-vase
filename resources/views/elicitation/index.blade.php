...
@section('modal')
    <div class="modal fade" id="importerModal" tabindex="-1" aria-labelledby="importerModalLabel" aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered modal-lg rounded-05">
            <div class="modal-content rounded-05">
                <form action="{{ route('elicitations.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="alert alert-info">
                                ...
                                <ul>
                                    ...
                                    <li>- Le fichier doit contenir les colonnes suivantes :
                                        <strong>Code Elicitation, Code UIC de l'Index, Sexe, Date de Naissance, Lien avec le
                                            cas Index, Contact Testé : Oui / Non</strong>
                                    </li>
                                    <li>
                                        <hr>
                                    ...
                                    <li>
                                        <div class="">
                                            ...
                                            <a href="{{ asset('exemple/elicitations.xlsx') }}"
    ...
    @foreach ($elicitations as $elicitation)
        <div class="modal fade" id="elicitationModal{{ $elicitation->id }}" tabindex="-1"
            aria-labelledby="importerModalLabel" aria-hidden="true">
            <div class="modal-dialog  modal-dialog-centered modal-lg rounded-05">
                <div class="modal-content rounded-05">

                    <div class="modal-header">
                        <h5 class="modal-title" id="importerModalLabel">Détails du Contact élicité
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-end">
                            <button class="btn btn-sm rounded-05 btn-secondary me-1" data-bs-toggle="modal"
                                ...
                                Importer</button>
                            <a href="{{ route('elicitations.create') }}" class="btn btn-sm btn-primary rounded-05">
                                Nouveau</a>
                        </div>
                        <div class="col mb-2">
                            <h5 class="card-title text-dark fw-bolder mb-0">Elicitation(s)</h5>
                            <span>Liste des Elicitation(s)</span>
                            <hr>
                        </div>
                            ...
                            <table class="table table-striped table-hover datatable">
                                <thead class="thead">
                                    <tr>
                                        ...
                                        <th>Cas élicitation</th>
                                        <th>Relation avec Index </th>
                                        <th>Cas Index</th>
                                ...
                                <tbody>
                                    @foreach ($elicitations as $elicitation)
                                        <tr>
                                                ...
                                                <div class="d-flex align-items-center text-truncate">
                                                    ...
                                                    <div class="ms-3">
                                                        ...
                                                        <p class="card-subtitle">
                                                            {{ $elicitation->DateNaissance->format('d-m-Y') }}</p>
                                            ...
                                            <td>{{ $elicitation->relationElicitation->LibelleRelation . ' ( ' . $elicitation->relationElicitation->CodeRelation . ')' }}
                                            </td>
                                            ...
                                            <td>{{ $elicitation->isTested ? 'OUI' : 'NON' }}</td>
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton"
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item d-flex align-items-center gap-3"
                                                                {{-- href="{{ route('elicitations.show', $elicitation->id) }}" --}} data-bs-toggle="modal"
                                                                data-bs-target="#elicitationModal{{ $elicitation->id }}">
                                                                <i class="fs-4 ti ti-eye"></i> Détails
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item d-flex align-items-center gap-3"
                                                                href="{{ route('elicitations.edit', $elicitation->id) }}">
                                                                <i class="fs-4 ti ti-edit"></i> Modifier
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <form
                                                                action="{{ route('elicitations.destroy', $elicitation->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                ...
                                                {{--
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            <a class="dropdown-item" href="{{ route('elicitations.show',$elicitation->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Détails') }}</a>
                                                            <a class="dropdown-item" href="{{ route('elicitations.edit',$elicitation->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Modifier') }}</a>
                                                            <div class="dropdown-divider"></div>
                                                            <form action="{{ route('elicitations.destroy',$elicitation->id) }}" method="POST">
                                                                @csrf
                                                                @method('DELETE')
