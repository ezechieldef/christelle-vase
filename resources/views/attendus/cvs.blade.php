<div class="row">
    ...
    @forelse ($rdvCVs as $rdv)
        @php
            $rdvCV = $rdv;
        @endphp
        <div class="modal fade" id="modalDetailCV{{ $rdv->id }}" tabindex="-1" aria-labelledby="importerModalLabel"
            aria-hidden="true">
            <div class="modal-dialog  modal-dialog-centered modal-lg rounded-05">
                <div class="modal-content rounded-05">

                    <div class="modal-header">
                        <h5 class="modal-title" id="importerModalLabel">Détails du Rendez-vous CV |
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <a data-bs-toggle="modal" data-bs-target="#modalDetailCV{{ $rdv->id }}"
