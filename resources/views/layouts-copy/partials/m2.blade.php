    ...
    <div class="scroll-sidebar simplebar-scrollable-y" data-simplebar="init">
                            ...
                            <nav class="sidebar-nav">
                                <ul id="sidebarnav" class="mb-0">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link primary-hover-bg active" href="index.html"
                                            aria-expanded="false">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link sidebar-link success-hover-bg" href="index2.html"
                                            aria-expanded="false">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link has-arrow success-hover-bg" href="#"
                                            aria-expanded="false">
                                            <span class="aside-icon p-2 bg-success-subtle rounded-1">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link has-arrow warning-hover-bg" href="#"
                                            aria-expanded="false">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link has-arrow danger-hover-bg" href="#"
                                            aria-expanded="false">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link indigo-hover-bg" href="app-email.html"
                                            aria-expanded="false">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link info-hover-bg" href="app-calendar.html"
                                            aria-expanded="false">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link success-hover-bg" href="app-kanban.html"
                                            aria-expanded="false">
                                            <span class="aside-icon p-2 bg-success-subtle rounded-1">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link primary-hover-bg" href="app-chat.html"
                                            aria-expanded="false">
                                            <span class="aside-icon p-2 bg-primary-subtle rounded-1">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link secondary-hover-bg" href="app-notes.html"
                                            aria-expanded="false">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link success-hover-bg" href="app-contact.html"
                                            aria-expanded="false">
                                            <span class="aside-icon p-2 bg-success-subtle rounded-1">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link warning-hover-bg" href="app-contact2.html"
                                            aria-expanded="false">
                                            <span class="aside-icon p-2 bg-warning-subtle rounded-1">
                                                <iconify-icon icon="solar:list-check-line-duotone"
                                                    class="fs-6"></iconify-icon>
                                            </span>
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link danger-hover-bg" href="app-invoice.html"
                                            aria-expanded="false">
                                            <span class="aside-icon p-2 bg-danger-subtle rounded-1">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link indigo-hover-bg" href="page-pricing.html"
                                            aria-expanded="false">
                                            <span class="aside-icon p-2 bg-indigo-subtle rounded-1">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link info-hover-bg" href="page-faq.html"
                                            aria-expanded="false">
                                            <span class="aside-icon p-2 bg-info-subtle rounded-1">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link primary-hover-bg" href="page-account-settings.html"
                                            aria-expanded="false">
                                            <span class="aside-icon p-2 bg-primary-subtle rounded-1">
                                                <iconify-icon icon="solar:user-circle-line-duotone"
                                                    class="fs-6"></iconify-icon>
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link has-arrow secondary-hover-bg" href="#"
                                            aria-expanded="false">
                                            <span class="aside-icon p-2 bg-secondary-subtle rounded-1">
                                    ...
                                    <!-- =================== -->
                                    <li class="sidebar-item">
                                        <a class="sidebar-link sidebar-link indigo-hover-bg" href="classes.html"
                                            aria-expanded="false">
                                            <span class="aside-icon p-2 bg-indigo-subtle rounded-1">
                                    ...
                                    <!-- =================== -->
                                    <li class="sidebar-item">
                                        <a class="sidebar-link sidebar-link info-hover-bg" href="attendance.html"
                                            aria-expanded="false">
                                            <span class="aside-icon p-2 bg-info-subtle rounded-1">
                                                <iconify-icon icon="solar:file-check-line-duotone"
                                                    class="fs-6"></iconify-icon>
                                            </span>
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link has-arrow success-hover-bg" href="#"
                                            aria-expanded="false">
                                            <span class="aside-icon p-2 bg-success-subtle rounded-1">
                                                <iconify-icon icon="solar:command-line-duotone"
                                                    class="fs-6"></iconify-icon>
                                            </span>
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link has-arrow success-hover-bg" href="#"
                                            aria-expanded="false">
                                            <span class="aside-icon p-2 bg-success-subtle rounded-1">
                                                <iconify-icon icon="solar:ruler-line-duotone"
                                                    class="fs-6"></iconify-icon>
                                            </span>
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link has-arrow primary-hover-bg" href="#"
                                            aria-expanded="false">
                                            <span class="aside-icon p-2 bg-primary-subtle rounded-1">
                                                <iconify-icon icon="solar:qr-code-line-duotone"
                                                    class="fs-6"></iconify-icon>
                                            </span>
                                    ...
                                    <!-- =================== -->
                                    <li class="sidebar-item">
                                        <a class="sidebar-link has-arrow indigo-hover-bg" href="#"
                                            aria-expanded="false">
                                            <span class="aside-icon p-2 bg-indigo-subtle rounded-1">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link has-arrow indigo-hover-bg" href="#"
                                            aria-expanded="false">
                                            <span class="aside-icon p-2 bg-indigo-subtle rounded-1">
                                                <iconify-icon icon="solar:dna-bold-duotone"
                                                    class="fs-6"></iconify-icon>
                                            </span>
                                    ...
                                    <!-- =================== -->
                                    <li class="sidebar-item">
                                        <a class="sidebar-link sidebar-link warning-hover-bg" href="form-wizard.html"
                                            aria-expanded="false">
                                            <span class="aside-icon p-2 bg-warning-subtle rounded-1">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link sidebar-link primary-hover-bg"
                                            href="form-repeater.html" aria-expanded="false">
                                            <span class="aside-icon p-2 bg-primary-subtle rounded-1">
                                                <iconify-icon icon="solar:star-circle-line-duotone"
                                                    class="fs-6"></iconify-icon>
                                            </span>
                                    ...
                                    <!-- =================== -->
                                    <li class="sidebar-item">
                                        <a class="sidebar-link has-arrow info-hover-bg" href="#"
                                            aria-expanded="false">
                                            <span class="aside-icon p-2 bg-info-subtle rounded-1">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link has-arrow danger-hover-bg" href="#"
                                            aria-expanded="false">
                                            <span class="aside-icon p-2 bg-danger-subtle rounded-1">
                                                <iconify-icon icon="solar:file-line-duotone"
                                                    class="fs-6"></iconify-icon>
                                            </span>
                                    ...
                                    <!-- =================== -->
                                    <li class="sidebar-item">
                                        <a class="sidebar-link sidebar-link secondary-hover-bg"
                                            href="icon-tabler.html" aria-expanded="false">
                                            <span class="aside-icon p-2 bg-secondary-subtle rounded-1">
                                                <iconify-icon icon="solar:archive-broken"
                                                    class="fs-6"></iconify-icon>
                                            </span>
                                    ...
                                    <!-- =================== -->
                                    <li class="sidebar-item">
                                        <a class="sidebar-link sidebar-link primary-hover-bg" href="icon-solar.html"
                                            aria-expanded="false">
                                            <span class="aside-icon p-2 bg-primary-subtle rounded-1">
                                                <iconify-icon icon="solar:sticker-smile-circle-2-linear"
                                                    class="fs-6"></iconify-icon>
                                            </span>
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link sidebar-link success-hover-bg"
                                            href="authentication-error.html" aria-expanded="false">
                                            <span class="aside-icon p-2 bg-success-subtle rounded-1">
                                                <iconify-icon icon="solar:danger-circle-line-duotone"
                                                    class="fs-6"></iconify-icon>
                                            </span>
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link has-arrow warning-hover-bg" href="#"
                                            aria-expanded="false">
                                            <span class="aside-icon p-2 bg-warning-subtle rounded-1">
                                                <iconify-icon icon="solar:login-2-line-duotone"
                                                    class="fs-6"></iconify-icon>
                                            </span>
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link sidebar-link primary-hover-bg"
                                            href="authentication-maintenance.html" aria-expanded="false">
                                            <span class="aside-icon p-2 bg-primary-subtle rounded-1">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link sidebar-link success-hover-bg"
                                            href="../docs/index.html" aria-expanded="false">
                                            <span class="aside-icon p-2 bg-success-subtle rounded-1">
                                                <iconify-icon icon="solar:file-text-line-duotone"
                                                    class="fs-6"></iconify-icon>
                                            </span>
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link sidebar-link success-hover-bg opacity-50"
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link sidebar-link indigo-hover-bg justify-content-between"
                                            ...
                                            <div class="d-flex align-items-center">
                                                <span class="aside-icon p-2 bg-indigo-subtle rounded-1">
                                                    <iconify-icon icon="solar:smile-circle-line-duotone"
                                                        class="fs-6"></iconify-icon>
                                                </span>
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link sidebar-link info-hover-bg" href="#"
                                            aria-expanded="false">
                                            <span class="aside-icon p-2 bg-info-subtle rounded-1">
                                                <iconify-icon icon="solar:star-line-duotone"
                                                    class="fs-6"></iconify-icon>
        ...
        <div class="simplebar-track simplebar-vertical" style="visibility: visible;">
            <div class="simplebar-scrollbar"
                style="height: 69px; transform: translate3d(0px, 0px, 0px); display: block;"></div>
        </div>
    </div>
            ...
            <div class="card-body p-4">
                <div class="d-flex align-items-center justify-content-between gap-3">
                    <div class="d-flex align-items-center gap-3">
                        <img src="./../assets/images/profile/user-1.jpg" width="45" height="45"
