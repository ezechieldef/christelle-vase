<aside class="left-sidebar with-vertical">
    ...
    <div class="brand-logo d-flex align-items-center justify-content-between">
        <a href="{{ route('home') }}" class="text-nowrap logo-img">
            @if ($dark_Theme)
                <img src="{{ asset('spike/armur-logo-text-white.png') }}" class="dark-logo" width="180" alt="" />
            @else
                <img src="{{ asset('spike/armur-logo-text-black.png') }}" class="light-logo" width="180"
                    alt="" />
            @endif
            {{-- <img src="{{ asset('spike/assets/images/logos/logo-light.svg') }}" class="dark-logo" alt="Logo-Dark" />
            <img src="{{ asset('spike/assets/images/logos/logo-dark.svg') }}" class="light-logo" alt="Logo-light" /> --}}
        </a>
    ...
    <div class="scroll-sidebar" data-simplebar>
        ...
        <nav class="sidebar-nav">
            {{-- <ul id="sidebarnav" class="mb-0">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link success-hover-bg" href="app-kanban.html" aria-expanded="false">
                        <span class="aside-icon p-2 bg-success-subtle rounded-1">
                ...
                <!-- =================== -->
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link primary-hover-bg" href="icon-solar.html" aria-expanded="false">
                        <span class="aside-icon p-2 bg-primary-subtle rounded-1">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link success-hover-bg" href="authentication-error.html"
                        aria-expanded="false">
                        <span class="aside-icon p-2 bg-success-subtle rounded-1">
                            <iconify-icon icon="solar:danger-circle-line-duotone" class="fs-6"></iconify-icon>
                        </span>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link danger-hover-bg justify-content-between" href="#"
                        aria-expanded="false">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link indigo-hover-bg justify-content-between" href="#"
                        aria-expanded="false">
                        <div class="d-flex align-items-center">
                            <span class="aside-icon p-2 bg-indigo-subtle rounded-1">
            ...
            <ul id="sidebarnav">
                ...
                <!-- ============================= -->
                <li class="sidebar-item">
                    <a class="sidebar-link two-column indigo-hover-bg" href="#" aria-expanded="false">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link two-column has-arrow indigo-hover-bg" href="#" aria-expanded="false">
                        ...
                        <span class="hide-menu ps-1">Mon Compte</span>
                    </a>
                    <ul aria-expanded="false" class="collapse first-level">
                        <!-- Teachers -->
                        <li class="sidebar-item">
                            <a href="all-teacher.html" class="sidebar-link">
                                <span class="sidebar-icon"></span>
                                <span class="hide-menu text-truncate">Mes Commandes</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a href="teacher-details.html" class="sidebar-link">
                                <span class="sidebar-icon"></span>
                                <span class="hide-menu text-truncate">Historique</span>
                            </a>
                        </li>
                    </ul>
                </li>
                <li class="sidebar-item ">
                    <a class="sidebar-link two-column indigo-hover-bg {{ Request::is('suivre-commande*') ? 'active' : '' }}"
                        href="{{ route('suivre-commande') }}" aria-expanded="false">
            ...
            <div class="card-body p-4">
                <div class="d-flex align-items-center justify-content-between gap-3">
                    <div class="d-flex align-items-center gap-3">
                        <img src="{{ asset('spike/assets/images/profile/user-1.jpg') }}" width="45" height="45"
